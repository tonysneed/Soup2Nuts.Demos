...
namespace SoupToNuts.Final.Client.Common.ViewModels
{
    ...
    {
        private readonly ICustomerService _customerServiceAgent;
        private readonly IOrderService _orderServiceAgent;
        ...
        public CustomerOrdersViewModel(
            ICustomerService customerServiceAgent,
            IOrderService orderServiceAgent)
        {
